ConnectHub Social Media Data Analysis::

Project Overview:
This project simulates a real-world social media platform called ConnectHub. The objective is to analyze user activity, relationships, and engagement using SQL. The project focuses on extracting meaningful insights from relational data using advanced SQL concepts such as JOINs, subqueries, and stored procedures/functions.
